        ...
        <div class="container">
            <div class="st-main-header-in">
                <div class="st-main-header-left">
                    <a class="st-site-branding" href="{{route('home')}}"><img src="assets/img/logo.png" alt="Davis"></a>
                </div>
                <div class="st-main-header-right">
                    <div class="st-nav">
                        <ul class="st-nav-list st-onepage-nav">
                            <li><a href="{{route('home')}}" class="st-smooth-move nav-link">Home</a></li>
                            <li><a href="{{route('about')}}" class="st-smooth-move">About</a></li>
                            <li><a href="{{route('resume')}}" class="st-smooth-move">Resume</a></li>
                            <li><a href="{{route('portfolio')}}" class="st-smooth-move">Portfolio</a></li>
                            <li><a href="{{route('blog')}}" class="st-smooth-move">Blog</a></li>
                            <li><a href="{{route('contact')}}" class="st-smooth-move">Contact</a></li>
                        </ul>
                        <div class="sp-phone">
